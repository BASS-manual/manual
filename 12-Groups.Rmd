...
We will show the possibilities with this functionality through a common project setup:
...
For the *Excluded* group we only want to be able to send out a predefined email notification (an assessment without instruments) informing the participant of the exclusion. No other assessments should be available, which can be achieved through the following setup:
