...
**Project security** lets you define what security measures your project will use, such as two-factor authentication. These settings pertain to participants' use of the system.
