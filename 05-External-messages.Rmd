...
Nestled below that is the dropdown menu *Delivery method for new message notifications to therapists*. The SMS options is as of this writing defunct, so the only valid option is ”E-post”.
