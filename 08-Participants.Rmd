...
Depending on which project is selected in the dropdown in the main menu, the result in the "Participants" view will differ. If a specific project is selected, only gparticipants in that project wil be shown under each tab.
