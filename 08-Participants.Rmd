...
- *Graphs*, where you can see graphs on the answers the participant has given on recurring assessments. The graphs do not show individual items but only scoring.
