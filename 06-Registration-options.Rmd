...
**Registration group**
This lets you select a previously created group as the default group newly registered participant accounts are placed into. This is mandatory if you want participants to access and complete an assessment as part of their registration. To do this, set the relevant group as the Registration group, and activate an assessment for that group
...
>**Note**: For participants manually created in the administrative view consent will ***not*** be collected. If consent should be collected for these participants you need to create an instrument and administer it through an assessment. 
