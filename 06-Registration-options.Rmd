...
This lets you write a JavaScript function to check whether participants adhere to the PID format you’ve presented. Upon request, we can supply a function to verify Swedish personnummer. 
